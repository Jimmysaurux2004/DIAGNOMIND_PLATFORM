<?php
class GetHeaderPaciente {
    public function headerPacienteShow($nombre_usuario, $nombres, $apellidos, $dni) {
        ?>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown position-relative me-2">
                <button class="btn d-flex align-items-center" id="userDropdown" onclick="toggleUserMenu(event)">
                    ...
                    <span class="txt-span-header">Paciente: <?= htmlspecialchars($nombre_usuario) ?></span>
                </button>
                ...
                <div id="userMenu" class="user-menu">
                    <div class="text-center">
                        ...
                        <small class="text-muted">DNI: <?= htmlspecialchars($dni) ?></small>
                    </div>
                    <hr>
